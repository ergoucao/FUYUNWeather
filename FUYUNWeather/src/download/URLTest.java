...
//                return "获取失败";
    ...
    /*
     ...
     返回值：无
  */
    void testJson(String urlString,String acode) throws JSONException
    {
...
//        JSONArray casts=jsonObject.getJSONArray("casts");
        ...
        for (int i=0;i<forecasts.length();i++)
        {
            ...
            for (int j=0;j<casts.length();j++)
            {
                ...
                utilsToBuildFuYunWeatherDB jdbcDem02=new utilsToBuildFuYunWeatherDB();
                String sql="update date set name="+"'"+date+"'"+" where dateId="+(j+1);
                System.out.println(sql);
                jdbcDem02.updateTable(sql);
